...
def main():
    ...
    better_draw_circles(rg.Point(250,-100),2.8)

    even_better_draw_circles(rg.Point(300,200),20,3,'red')
    even_better_draw_circles(rg.Point(100,180),30,5,'blue')
    window.update()
...
def even_better_draw_circles(point,rad,number,pencolor):
